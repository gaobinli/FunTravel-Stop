...
import com.shopping.domain.dto.res.CarouselResDto;
import com.shopping.service.CarouselService;
...
@Data
@RestController
@Tag(name = "carousel", description = "轮播图")
...
public class CarouselController {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "currentPage", value = "当前页数", paramType = "query", dataTypeClass = Map.class),
            ...
            @ApiImplicitParam(name = "qp-name-eq", value = "轮播图名字", paramType = "query", dataTypeClass = Map.class),
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    @ApiImplicitParams({
            @ApiImplicitParam(name = "name", value = "轮播图名字", paramType = "query", dataTypeClass = Map.class),
    ...
    @ApiOperation(value = "查询所有轮播图", tags = {"carousel"}, nickname = "getList")
    @ApiResponses(value = {@ApiResponse(code = 200, message = "操作是否成功,000000:成功，否则失败")})
    @GetMapping(value = "/list", produces = {"application/json"})
    public ResultDTO<CarouselResDto> getList() {
        List<CarouselResDto> resDtos = carouselService.selectList();
