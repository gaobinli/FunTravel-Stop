...
import com.shopping.common.convertor.SysUserReqDtoConvertor;
...
public class SysUserServiceImpl implements SysUserService {
    ...
    @Override
    public List<SysUserResDto> list() {
        List<SysUserPo> list = sysUserPoService.getList(new MapUtil().put("qp-code-ne", "admin"), SysUserPo.class);
