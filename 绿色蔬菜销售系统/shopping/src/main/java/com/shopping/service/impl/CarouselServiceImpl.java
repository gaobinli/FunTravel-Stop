...
import com.shopping.common.convertor.CarouselReqDtoConvertor;
import com.shopping.common.convertor.CarouselResDtoConvertor;
...
public class CarouselServiceImpl implements CarouselService {
    ...
    @Override
    public List<CarouselResDto> selectList() {
        List<CarouselPo> list = carouselPoService.getList(new MapUtil(), CarouselPo.class);
        list = list.stream()
                .sorted(Comparator.comparing(CarouselPo::getSort).reversed())
